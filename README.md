<!-- =========================================================
     GitHub Profile README — Ahmed Ali Ibrahim (Ahmed-1Ali)
     Repo name must be exactly: Ahmed-1Ali  (public, with this README.md at root)
     ========================================================= -->
...
![Location](https://img.shields.io/badge/📍_Cairo,_Egypt-0d1117?style=for-the-badge&labelColor=0d1117&color=1f6feb)
![Role](https://img.shields.io/badge/Role-Cloud_%26_DevOps_Engineer-0d1117?style=for-the-badge&labelColor=1f6feb)
![Status](https://img.shields.io/badge/Open_to-Cloud_%2F_DevOps_Roles-0d1117?style=for-the-badge&labelColor=238636)
...
|:--|:--|:--|:--|
| Jul 2026 – Present | **DevOps Engineer** (Part-Time) | Reyada | Bitrix24 HA/DR infrastructure, GitLab CI/CD, Linux/MySQL/NFS support, Bash automation |
| May – Jun 2026 | DevOps Engineer Trainee | iVolve Technologies | Docker, Kubernetes, Jenkins, GitHub Actions, Terraform, Ansible |
| Apr – May 2026 | Cloud Engineer Trainee | e& Egypt | Linux, Docker, Kubernetes, multi-cloud fundamentals |
| Jan – Apr 2026 | Cloud Solution Architect Trainee | National Telecommunication Institute (NTI) | RHCSA content, VMware vSphere, AWS, Huawei Cloud, OpenShift (DO180) |
| May – Jun 2025 | Network Security Engineer Trainee | BARQ Systems | FortiGate, VLANs, SD-WAN, IPsec/SSL VPN, HA |

<!-- OPTIONAL: Client details (e.g., the KSA client) are intentionally not named here. Add them only if you are allowed to disclose them publicly. -->
...
### 1️⃣ Bitrix24 High Availability, Shared Storage & Disaster Recovery
...
`Rocky Linux` `Bitrix24` `Apache` `PHP-FPM` `NFS` `MySQL/Percona` `Bash` `systemd` `SELinux` `firewalld`

[📂 Repository](https://github.com/Ahmed-1Ali?tab=repositories) <!-- TODO: replace with the repo URL -->

<!-- NOTE: Your CV lists the database layer of this project as MySQL/Percona, while your brief also mentions EnterpriseDB PostgreSQL. I kept MySQL/Percona here and covered EnterpriseDB in project 4. Edit if both were part of the same project. -->
...
### 3️⃣ AWS Bitrix Infrastructure
> Secure, highly available cloud infrastructure on AWS.
...
### 4️⃣ EnterpriseDB PostgreSQL High Availability & Automatic Failover
...
`EDB Advanced Server` `PostgreSQL` `Streaming Replication` `EFM` `pg_basebackup` `WAL` `Linux` `Bash` `firewalld`
...
<a href="https://www.linkedin.com/in/ahmed-ibrahim-829348256">
  <img src="https://img.shields.io/badge/LinkedIn-Ahmed_Ali_Ibrahim-0A66C2?style=for-the-badge" alt="LinkedIn" />
</a>
<a href="mailto:ahdeabis@gmail.com">
  <img src="https://img.shields.io/badge/Email-ahdeabis@gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" />
</a>
<a href="https://github.com/Ahmed-1Ali">
  <img src="https://img.shields.io/badge/GitHub-Ahmed--1Ali-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" />
</a>
<!-- OPTIONAL: Add your portfolio / website here if you have one:
<a href="https://YOUR-PORTFOLIO-URL">
  <img src="https://img.shields.io/badge/Portfolio-Visit-1f6feb?style=for-the-badge" alt="Portfolio" />
</a>
-->
...
<!-- NOTE: Your phone number is deliberately left out of this public profile. Add it only if you want it public. -->
